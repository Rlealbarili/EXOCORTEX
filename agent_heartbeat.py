...
# CONFIGURATION
API_KEY = "moltbook_sk_Vqmwq6-YawcKm71CvKK6iCrQ09kXwVws"  # Embedded for standalone execution
...
def check_identity():
    res = api_request("agents/me")
    if res and res.get('success'):
        log(f"Identity Confirmed: {res['agent']['name']} | 🦞")
        return True
    return False
